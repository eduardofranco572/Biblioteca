							...
							<?php
									$codigo = $_POST['codigo'];
										...
										if($codigo == ''){
											...
											echo ("	Codigo: </br> <input type='text' name='id' value='".$linha["id"]."'/><br/></br>");
											...
											echo ("	Data de Nascimento: </br> <input type='text' name='data_nasc' value='".$linha["dataNasc"]."'/><br/></br>");
											echo ("	E-Mail: </br> <input type='text' name='email' value='".$linha["email"]."'/><br/></br>");
											echo ("	Telefone: </br> <input type='text' name='telefone' value='".$linha["telefone"]."'/><br/></br>");
