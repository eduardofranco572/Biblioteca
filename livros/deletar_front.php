							...
							<?php
									$codigo = $_POST['codigo'];
										...
										if($codigo == ''){
											...
											echo ("<form enctype='multipart/form-data' method='POST' action='deletar_beck.php'>");
                                            echo ("	</br> Codigo: </br> <input type='text' name='id' value='".$linha["id"]."'/><br/></br>");
                                            echo ("	</br> Nome: </br> <input type='text' name='nome' value='".$linha["nome"]."'/><br/></br>");
                                            echo ("	Editora: </br> <input type='text' name='editora' value='".$linha["editora"]."'/><br/></br>");
                                            echo ("	Ano: </br> <input type='text' name='ano' value='".$linha["ano"]."'/><br/></br>");
                                            echo ("	Altor: </br> <input type='text' name='altor' value='".$linha["altor"]."'/><br/></br>");
                                            echo ("	Genero: </br> <input type='text' name='genero' value='".$linha["genero"]."'/><br/></br>");
                                            echo ("	Sinopse: </br> <textarea name='sinopse'>".$linha["sinopse"]."</textarea><br/></br>");
											echo ("Imagem do aluno: </br><input type='file' name='img'<br/><br/>");
											echo("<div class='botao'>");
											echo ("	<input class=' cadastar' type='submit' value='Deletar' />");
											echo("</div>");
											echo ("</form>");										
										}
								?>
