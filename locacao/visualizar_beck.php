                                ...
                                $view = $database->query ( $comando );
                                    ...
                                    echo"<div class='tudo2'>";
                                        ...
                                        echo"<div class='conteudo2'>";
                                            echo"</br>";
                                            echo"</br>";
                                            echo ("	</br> Leitor: </br> <input type='text' name='leitor' disabled value='".$linha["codLeitor"]."'/><br/></br>");
                                            echo ("	Livro: </br> <input type='text' name='livro' disabled value='".$linha["codLivro"]."'/><br/></br>");
