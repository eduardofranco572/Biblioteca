...
<html lang="pt-br">
    ...
    <div class="tudo">
        <div class="conteiner">
            <h1>Tabela com as Informações da Locação</h1>
            <div class="conteudo">
            ...
            <?php
                    ...
                    $camp = $_POST['campo'];
                        ...
                        $comando ="SELECT locacao.id as id, leitores.nome as leitor, livros.nome as livro, livros.id as img
                        from locacao
                        inner join leitores on locacao.codLeitor = leitores.id inner join livros on locacao.codLivro = livros.id
                        WHERE $camp LIKE '%$ref%';";
                        ...
                        if($camp == ''){
                            ...
                            while($linha = $view-> fetch_assoc()){
                                echo"<div class='info'>";
                                    ...
                                    echo"<img src='../livros/script.php?id=".$img.">'";
                                    echo"</br>";
                                    
                                    echo"<div class='nomes'>";
                                    echo "Codigo: ".$linha["id"];
                                    echo"</br>";
                                    echo "Nome Leitor: ".$linha["leitor"];
                                    echo"</br>";
                                    echo "Nome Livro: ".$linha["livro"];
                                    echo"</br>";
                                    echo"</div>";
